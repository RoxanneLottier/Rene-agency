...
layout: project
title: La Fleur Nue
permalink: /La-Fleur-Nue/
tag1: Web-development,
tag2: Web-design
tag3:
tag4:
techstack1: Wordpress
...
fonct2:
fonct3:
description: Client qui souhaitait un site e-commerce pour le lancement de sa marque d'infusion. Seule une identité visuelle avait été fournie. Réalisation de maquettes sur-mesure, intégration de la maquette sur Wordpress. Illustration d'icônes réalisées sur-mesure.
